...
if(!isset($_SESSION))
    ...
    $selectQuery = ("SELECT a.nome, b.ultimo_log FROM usuarios a, chat_logs b
    ...
    while($resultado = mysqli_fetch_assoc($loadQuery)){
        ...
        fwrite($logHostoryUser, "<b><a class='logLine' href='#'>" . $resultado['ultimo_log'] . " - " . $resultado['nome'] . "</a></b>");
    }
